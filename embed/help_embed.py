...
help_embed.add_field(name="?정보등록", value="?정보등록 [이름] [생년월일] [지역] [학교이름] [학교타입] [비밀번호]```?정보등록 조재범 060703 경기 율현중 중학교 1234``````?정보등록 조재범 060703 서울시 율현중 중학교 1234```※정보등록은 `개인DM`으로 하는 것을 보안상 추천 드립니다.", inline=False)
help_embed.add_field(name="?정보삭제", value="※디스코드 아이디를 기준으로 삭제합니다.\n※만약 디스코드 계정이 바뀌었을 경우 재범#0490 님께 문의 부탁드립니다.", inline=False)
